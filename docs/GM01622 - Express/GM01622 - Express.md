...
[Section 1: Express.js](#express.js)

[1 - Routes](#routes)

[2 - Middleware](#middleware)

[Section 2: Intermediate Express.js](#intermediate-express.js)
...
The server sends a 204 No Content status code is deletion occurs without
error.
